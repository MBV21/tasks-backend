...
pipeline {
    ...
    stages {
        ...
        stage ('Quality Gate') {
            steps {
                sleep(45) // necessário dar algum tempo para que o quality gate seja mensurado
        ...
        stage ('API Test') {
            steps {
                dir ('api-test') {
                    git credentialsId: 'GitHub_MBV21', url: 'https://github.com/MBV21/tasks-api-test.git'
                    bat 'mvn test'
                }
            }
        }
